<x-base-layout>
    ...
    <div class="p-4 md:p-10 max-w-2xl mx-auto">
        ...
        <ul class="mt-4 flex-wrap text-lg">
            <li class="mt-0 flex"><x-heroicon-o-check-circle class="mr-2 h-6 flex-shrink-0 text-pink-600" /> Daily Log - the heart of your system.</li>
            <li class="mt-4 flex"><x-heroicon-o-check-circle class="mr-2 h-6 flex-shrink-0 text-pink-600" /> Collections - create lists to manage projects, book recommendations, menu planning, and more!</li>
            <li class="mt-4 flex"><x-heroicon-o-check-circle class="mr-2 h-6 flex-shrink-0 text-pink-600" /> Share your collections with others - great for collaborative projects and family shopping lists.</li>
            <li class="mt-4 flex"><x-heroicon-o-check-circle class="mr-2 h-6 flex-shrink-0 text-pink-600" /> Show or hide complete items - sometimes you want to see how much you've done, and sometimes you just want to focus on what's left.</li>
        </ul>
        ...
        <p class="mt-2 text-center text-gray-600"><small>RocketLog is not affiliated with Bullet Journal, just a big fan :)</small></p>
    </div>
</x-base-layout>
